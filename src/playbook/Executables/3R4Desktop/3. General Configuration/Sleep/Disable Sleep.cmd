...
if %errorlevel%==1 (
	call "%windir%\3R4Desktop\3. General Configuration\Hibernation\Disable Hibernation (default).cmd" /silent
) else (
	call "%windir%\3R4Desktop\3. General Configuration\Hibernation\Enable Hibernation.cmd" /silent
)
