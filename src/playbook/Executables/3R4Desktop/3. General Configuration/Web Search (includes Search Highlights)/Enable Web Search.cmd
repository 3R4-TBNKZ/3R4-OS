...
:: Main settings
call "%windir%\3R4Modules\Scripts\settingsPages.cmd" /unhide search-permissions /silent
(
...
if %errorlevel%==1 call "%windir%\3R4Desktop\3. General Configuration\Search Indexing\Enable Search Indexing.cmd" /silent & set ____restart=true
exit /b