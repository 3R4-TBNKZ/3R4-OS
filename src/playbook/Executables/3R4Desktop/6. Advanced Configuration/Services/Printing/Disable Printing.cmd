...
call "%windir%\3R4Modules\Scripts\setSvc.cmd" Spooler 4
call "%windir%\3R4Modules\Scripts\setSvc.cmd" PrintWorkFlowUserSvc 4

call "%windir%\3R4Modules\Scripts\settingsPages.cmd" /hide printers
