...
# Duplicate Ultimate Performance power scheme, customize it and make it the 3R4 power scheme
...
powercfg /changename scheme_current "3R4 Power Scheme" "Power scheme optimized for optimal latency and performance."
...
& "$windir\3R4Modules\Scripts\toggleDev.cmd" -Disable '@("ACPI Processor Aggregator", "Microsoft Windows Management Interface for ACPI")' | Out-Null
