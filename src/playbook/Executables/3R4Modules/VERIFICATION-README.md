...
- Path: `\3R4Modules\Tools\multichoice.exe`
...
- Path: `\3R4Modules\Tools\SetTimerResolution.exe`
    ...
    - Version: v1.0.0
- Path: `\3R4Desktop\3. General Configuration\Timer Resolution\! MeasureSleep.exe`
...
> [!NOTE]  
> This is included in the Playbook and isn't in the 3R4Modules.
